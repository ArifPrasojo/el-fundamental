      ...
      <div className="mecha-panel w-full max-w-md p-8 relative shadow-[12px_12px_0px_rgba(28,61,138,0.5)]">
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <SubmitButton 
              className="w-full h-12 mt-4 font-bold uppercase tracking-widest rounded-none border-2 border-primary bg-primary text-primary-foreground hover:bg-primary/90 shadow-[6px_6px_0px_rgba(251,191,36,1)] hover:translate-y-1 hover:shadow-[2px_2px_0px_rgba(251,191,36,1)] transition-all"
          ...
          >
            <SubmitButton 
              variant="outline" 
              className="w-full h-12 border-2 border-border font-bold uppercase tracking-widest rounded-none bg-background hover:bg-primary/10 shadow-[4px_4px_0px_rgba(28,61,138,0.3)] hover:translate-y-1 hover:shadow-[2px_2px_0px_rgba(28,61,138,0.3)] transition-all"
